...
console.log('ENABLE_PIPEDREAM_INTEGRATION:', process.env.ENABLE_PIPEDREAM_INTEGRATION || 'not set (will default to enabled)');
console.log('PIPEDREAM_API_BASE_URL:', process.env.PIPEDREAM_API_BASE_URL || 'not set (will use default)');
console.log('PIPEDREAM_CONNECT_REDIRECT_URI:', process.env.PIPEDREAM_CONNECT_REDIRECT_URI || 'not set (will use default)');
