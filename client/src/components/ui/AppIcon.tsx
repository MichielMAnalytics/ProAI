    ...
    <div className={cn('relative flex-shrink-0', className)}>
      {src ? (
        <img
          ...
          className={cn(
            sizeClass,
            'rounded-sm object-contain drop-shadow-sm filter',
            variant === 'button' && 'min-h-4 min-w-4 bg-white/90 p-0.5 dark:bg-gray-100/90',
          )}
          style={{
            ...styles,
        ...
        <div
          className={cn(
            sizeClass,
            'flex items-center justify-center rounded-sm text-xs font-semibold shadow-sm',
            fallbackClass,
          )}
        >
          {firstLetter}
