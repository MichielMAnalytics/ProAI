...
export default function MobileNav({
  ...
  return (
    <div className="bg-token-main-surface-primary sticky top-0 z-10 flex min-h-[40px] items-center justify-center bg-surface-primary pl-1 dark:bg-surface-primary dark:text-white md:hidden">
      <button
        type="button"
